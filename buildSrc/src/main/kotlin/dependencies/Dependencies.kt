...
object Dependencies {
    ...
    const val KOIN_COMPAT = "io.insert-koin:koin-android-compat:${BuildDependenciesVersions.KOIN}"
    const val KOIN_WORK_MANAGER = "io.insert-koin:koin-androidx-workmanager:${BuildDependenciesVersions.KOIN}"
    const val KOIN_NAVIGATION_GRAPH = "io.insert-koin:koin-androidx-navigation:${BuildDependenciesVersions.KOIN}"
